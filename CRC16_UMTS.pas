...
type THasherCRC16_UMTS = class(THasherBase)
  private
    FHash: Word;
  public
...
constructor THasherCRC16_UMTS.Create;
begin
  inherited Create;
  FHash :=  $0000;
  Check := 'FEE8';
...
procedure THasherCRC16_UMTS.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC16_UMTS.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-16 UMTS', THasherCRC16_UMTS);
