...
type THasherCRC8_ICODE = class(THasherbase)
  private
    FHash: Byte;
  public
...
constructor THasherCRC8_ICODE.Create;
begin
  inherited Create;
  FHash :=  $FD;
  Check := '7E';
...
procedure THasherCRC8_ICODE.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC8_ICODE.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-8 I-CODE', THasherCRC8_ICODE);
