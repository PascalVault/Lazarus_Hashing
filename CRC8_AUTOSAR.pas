...
type THasherCRC8_AUTOSAR = class(THasherbase)
  private
    FHash: Byte;
  public
...
constructor THasherCRC8_AUTOSAR.Create;
begin
  inherited Create;
  FHash :=  $FF;
  Check := 'DF';
  ...
  procedure THasherCRC8_AUTOSAR.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC8_AUTOSAR.Final: String;
begin
  FHash := FHash xor $FF;
...
initialization
  HasherList.RegisterHasher('CRC-8 AUTOSAR', THasherCRC8_AUTOSAR);
