...
type THasherCKSUM_mpeg2 = class(THasherbase)
  private
    FHash: Cardinal;
  public
...
var Table: array[0..255] of Cardinal = (
...
constructor THasherCKSUM_mpeg2.Create;
begin
  inherited Create;
  FHash :=  $FFFFFFFF;
  Check := '0376E6E7';
...
procedure THasherCKSUM_mpeg2.Update(Msg: PByte; Length: Integer);
var i: Integer;
    Index: Cardinal;
begin
  for i:=0 to Length-1 do begin
    Index := ((FHash shr 24) xor Msg^) and $FF;
    FHash := (FHash shl 8) xor Table[Index];
    Inc(Msg);
  end;   
end;

function THasherCKSUM_mpeg2.Final: String;
begin
  FHash := FHash and $FFFFFFFF;
  Result := IntToHex(FHash, 8);
end;

initialization
  HasherList.RegisterHasher('CKSUM mpeg2', THasherCKSUM_mpeg2);
