...
type THasherCRC8_SMBUS = class(THasherbase)
  private
    FHash: Byte;
  public
...
constructor THasherCRC8_SMBUS.Create;
begin
  inherited Create;
  FHash :=  $00;
  Check := 'F4';
...
procedure THasherCRC8_SMBUS.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC8_SMBUS.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-8 SMBUS', THasherCRC8_SMBUS);
