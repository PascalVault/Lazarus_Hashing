...
type THasherCRC32_BZIP2 = class(THasherbase)
  private
    FHash: Cardinal;
  public
...
constructor THasherCRC32_BZIP2.Create;
begin
  inherited Create;
  FHash := $FFFFFFFF;
  Check := 'FC891918';
...
procedure THasherCRC32_BZIP2.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC32_BZIP2.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-32 BZIP2', THasherCRC32_BZIP2);
