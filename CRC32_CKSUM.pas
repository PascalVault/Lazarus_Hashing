...
type THasherCRC32_CKSUM = class(THasherbase)
  private
    FHash: Cardinal;
  public
...
constructor THasherCRC32_CKSUM.Create;
begin
  inherited Create;
  FHash := $00000000;
  Check := '765E7680';
...
procedure THasherCRC32_CKSUM.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC32_CKSUM.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-32 CKSUM', THasherCRC32_CKSUM);
