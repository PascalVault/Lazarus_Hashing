...
type THasherCRC32_MPEG2 = class(THasherbase)
  private
    FHash: Cardinal;
  public
...
constructor THasherCRC32_MPEG2.Create;
begin
  inherited Create;
  FHash := $FFFFFFFF;
  Check := '0376E6E7';
...
procedure THasherCRC32_MPEG2.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC32_MPEG2.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-32 MPEG-2', THasherCRC32_MPEG2);
