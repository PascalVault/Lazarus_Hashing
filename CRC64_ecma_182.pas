...
type THasherCRC64_ecma_182 = class(THasherBase)
  private
    FHash: QWord;
  public
...
constructor THasherCRC64_ecma_182.Create;
begin
  inherited Create;
  FHash :=  0;
...
procedure THasherCRC64_ecma_182.Update(Msg: PByte; Length: Integer);
var i: Integer;
    Index: Cardinal;
begin
...
function THasherCRC64_ecma_182.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-64 ecma 182', THasherCRC64_ecma_182);
