...
type THasherCRC8_HITAG = class(THasherbase)
  private
    FHash: Byte;
  public
...
constructor THasherCRC8_HITAG.Create;
begin
  inherited Create;
  FHash :=  $FF;
  Check := 'B4';
...
procedure THasherCRC8_HITAG.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC8_HITAG.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-8 HITAG', THasherCRC8_HITAG);
