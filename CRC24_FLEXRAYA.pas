...
type THasherCRC24_FLEXRAYA = class(THasherBase)
  private
    FHash: Cardinal;
  public
...
constructor THasherCRC24_FLEXRAYA.Create;
begin
  inherited Create;
  FHash :=  $FEDCBA;
  Check := '7979BD';
...
procedure THasherCRC24_FLEXRAYA.Update(Msg: PByte; Length: Integer);
var i: Integer;
    Index: Cardinal;
begin
...
function THasherCRC24_FLEXRAYA.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-24 FLEXRAY-A', THasherCRC24_FLEXRAYA);
