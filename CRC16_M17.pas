...
type THasherCRC16_M17 = class(THasherBase)
  private
    FHash: Word;
  public
...
constructor THasherCRC16_M17.Create;
begin
  inherited Create;
  FHash :=  $FFFF;
  Check := '772B';
...
procedure THasherCRC16_M17.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC16_M17.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-16 M17', THasherCRC16_M17);
