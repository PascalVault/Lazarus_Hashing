...
type THasherCRC24_LTEA = class(THasherBase)
  private
    FHash: Cardinal;
  public
...
constructor THasherCRC24_LTEA.Create;
begin
  inherited Create;
  FHash :=  $000000;
  Check := 'CDE703';
...
procedure THasherCRC24_LTEA.Update(Msg: PByte; Length: Integer);
var i: Integer;
    Index: Cardinal;
begin
...
function THasherCRC24_LTEA.Final: String;
begin
...
initialization
  HasherList.RegisterHasher('CRC-24 LTE-A', THasherCRC24_LTEA);
