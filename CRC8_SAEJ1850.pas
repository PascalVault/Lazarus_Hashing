...
type THasherCRC8_SAEJ1850 = class(THasherbase)
  private
    FHash: Byte;
  public
...
constructor THasherCRC8_SAEJ1850.Create;
begin
  inherited Create;
  FHash :=  $FF;
  Check := '4B';
...
procedure THasherCRC8_SAEJ1850.Update(Msg: PByte; Length: Integer);
var i: Integer;
begin
...
function THasherCRC8_SAEJ1850.Final: String;
begin
  FHash := FHash xor $FF;
...
initialization
  HasherList.RegisterHasher('CRC-8 SAE-J1850', THasherCRC8_SAEJ1850);
